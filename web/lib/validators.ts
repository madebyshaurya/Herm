...
export const telemetrySchema = z.object({
  ...
  gnss: z.object({
    ...
    fixQuality: z.number().min(0).max(9).default(0),
    mode: z.number().min(1).max(4).default(1),
    ...
    satsInUse: z.number().min(0).max(64).default(0),
    satsInView: z.number().min(0).max(128).default(0),
  ...
  system: z.object({
    ...
    ramUsedMb: z.number().min(0).nullable().optional(),
    ramTotalMb: z.number().min(0).nullable().optional(),
